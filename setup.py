...
PACKAGE_NAME = "smqtk_dataprovider"
...
if __name__ == "__main__":
    setuptools.setup(
        ...
        entry_points={
            'smqtk_plugins': {
                # DataElement
                ep_repeat("smqtk_dataprovider.impls.data_element.file"),
                ep_repeat("smqtk_dataprovider.impls.data_element.girder"),
                ep_repeat("smqtk_dataprovider.impls.data_element.hbase"),
                ep_repeat("smqtk_dataprovider.impls.data_element.matrix"),
                ep_repeat("smqtk_dataprovider.impls.data_element.memory"),
                ep_repeat("smqtk_dataprovider.impls.data_element.psql"),
                ep_repeat("smqtk_dataprovider.impls.data_element.url"),
                # DataSet
                ep_repeat("smqtk_dataprovider.impls.data_set.file"),
                ep_repeat("smqtk_dataprovider.impls.data_set.kvstore_backed"),
                ep_repeat("smqtk_dataprovider.impls.data_set.memory"),
                ep_repeat("smqtk_dataprovider.impls.data_set.psql"),
                # KeyValueStore
                ep_repeat("smqtk_dataprovider.impls.key_value_store.memory"),
                ep_repeat("smqtk_dataprovider.impls.key_value_store.postgres"),
            }
        }
    )

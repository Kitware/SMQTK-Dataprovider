...
class TestSafeFileWrite (unittest.TestCase):
    """
    Tests for the ``smqtk_dataprovider.utils.file.safe_file_write`` function.

    Mocking out underlying function that would have filesystem side effects.
    """

    @mock.patch('smqtk_dataprovider.utils.file.safe_create_dir')
    @mock.patch('smqtk_dataprovider.utils.file.os.rename')
